...
<aside id="separator-sidebar" class="fixed top-12 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-purple-50 dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="students/create" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Create Students</span>
      ...
      <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
         ...
         <li>
            <a href="contacts" class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
               <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
...
<div class="p-4 sm:ml-64">
   <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
      <div class="grid grid-cols-3 gap-4 mb-4">
         <div class="flex items-center justify-center h-24 rounded bg-green-200 dark:bg-gray-800">
            <p class="text-2xl text-gray-400 dark:text-gray-500">
               No. of Students
            </p>
         </div>
         <div class="flex items-center justify-center h-24 rounded bg-orange-200 dark:bg-gray-800">
            <p class="text-2xl text-gray-400 dark:text-gray-500">
               No. of Classes
            </p>
         </div>
