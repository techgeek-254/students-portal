 ...
 <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8 ">
    ...
    <div class="text-center border border-gray-200 px-20 py-20 rounded-lg shadow-md hover:ring-red-200 hover:ring hover:cursor-not-allowed">
      ...
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <a href="dashboard" class="rounded-md bg-purple-800 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-purple-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-600">Go back home</a>
        <a href="contacts" class="text-sm font-semibold text-gray-900">Contact IT Support <span aria-hidden="true">&rarr;</span></a>
      </div>
    </div>
  </main>
 </body>
